    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-md mx-4 bg-white rounded-2xl shadow-2xl">
        ...
        <div className="relative border-b border-gray-200 px-6 py-4">
          <h3 className="font-serif text-2xl font-semibold text-charcoal">Join the Waitlist</h3>
          <p className="mt-1 text-sm text-gray-600">Be the first to know when Parentis launches</p>
          <button
            onClick={onClose}
